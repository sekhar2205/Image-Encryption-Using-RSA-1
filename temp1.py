...
def decrypt_image():
    ...
    # Return the decrypted image as a base64 string with MIME type
    mime_type = "image/png"  # Assuming the decrypted image is PNG
    image_base64 = base64.b64encode(decrypted_image).decode('utf-8')
    image_data_uri = f"data:{mime_type};base64,{image_base64}"

    return jsonify({'decrypted_image': image_data_uri})
